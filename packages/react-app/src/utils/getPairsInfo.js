...
export async function getPairsInfo(pairAddresses, web3) {
  ...
  console.log(`Pairs addresss: ${pairAddresses}`)
  for (let i = 0; i < pairAddresses.length; ++i) {
    ...
    console.log(`TokenABI is: ${tokenABI}`)
  ...
  console.log(`Pairs Info is: ${pairsInfo}`)
  return pairsInfo;
}